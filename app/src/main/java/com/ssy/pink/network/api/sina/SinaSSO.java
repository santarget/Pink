...
public class SinaSSO {
    ...
    Set<SinaAccout> sinaAccoutSet = new HashSet<>();
    private String door = "";
    ...
    public void downloadImage(PreLoginInfo preLoginInfo) throws Exception {
...
//            }
        ...
        EventBus.getDefault().post("downloadcodepng");
        Log.i("aaaa", "下载验证码完毕！");
    }
    ...
    private void repost(SinaAccout sinaAccout, String weiboId) {
        ...
        if (sinaAccout.getHttpClient() == null) {
            httpClient = new DefaultHttpClient();
            sinaAccout.setHttpClient(httpClient);
        } else {
            httpClient = sinaAccout.getHttpClient();
        }

        if (sinaAccout.getSsoResponse() == null) {
            List<String> urlList = sinaAccout.getWeiboLoginInfo().getCrossDomainUrlList();
            ...
            try {
                ...
                sinaAccout.setSsoResponse(ssoResponse);
        ...
        try {
            ...
            if (responsez != null) {
                ...
                if (resEntityz != null) {
                    ...
                    sinaAccout.setRepostResult(repostResult);
                } else {
                    Log.i("aaaa", "responsez HttpEntity is null:" + responsez.toString());
                }
            } else {
                Log.i("aaaa", "responsez is null");
            }
        } catch (IOException e) {
    ...
    public void repost(String weiboId) {
        //"4289628737675854"
        if (sinaAccoutSet.size() == 0) {
            return;
        }
        for (SinaAccout sinaAccout : sinaAccoutSet) {
            repost(sinaAccout, weiboId);
        }
    }
     ...
     * @throws IOException
     */
    private PreLoginInfo getServerInfo() throws IOException {
        ...
        PreLoginInfo preLoginInfo = JsonUtils.toObject(importantText, PreLoginInfo.class);
