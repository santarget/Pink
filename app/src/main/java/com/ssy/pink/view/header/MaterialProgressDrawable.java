...
package com.ssy.pink.view.header;
...
public class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    private static class Ring {
         ...
         *
         * @param width Width of the hypotenuse of the arrow_right head
         * @param height Height of the arrow_right point
         */
        ...
        /**
         * @param show Set to true to show the arrow_right head on the progress spinner.
         */
